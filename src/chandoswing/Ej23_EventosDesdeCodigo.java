 ...
 * @author xpastrodr
 */
public class Ej23_EventosDesdeCodigo extends javax.swing.JFrame {
    JLabel etiTexto;
    JLabel etiZona;
    
    /**
     * Creates new form Ej23_EventosDesdeCodigo
     */
    public Ej23_EventosDesdeCodigo() {
        initComponents();
        CreacionVentana();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ej23_EventosDesdeCodigo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ej23_EventosDesdeCodigo().setVisible(true);
            }
        });
    }
