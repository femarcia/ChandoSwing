 ...
 * @author dtourpine
 */
public class Ej26_VectoresEventos extends javax.swing.JFrame {
    JButton vBotones[];
    
    public Ej26_VectoresEventos() {
        initComponents();
        CreacionVentana();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ej26_VectoresEventos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ej26_VectoresEventos().setVisible(true);
            }
        });
    }
