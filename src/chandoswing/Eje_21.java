 ...
 * @author higlediaz
 */
public class Eje_21 extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Eje_21.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
