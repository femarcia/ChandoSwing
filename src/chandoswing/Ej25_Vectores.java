 ...
 * @author msueivida
 */
public class Ej25_Vectores extends javax.swing.JFrame {
    JCheckBox vcuadros[];
    JButton btnAceptar;
    /**
     * Creates new form Ej25_Vectores
     */
    public Ej25_Vectores() {
        initComponents();
        CreacionVentana();
    ...
    public void CreacionVentana(){
        ...
        this.setTitle("Ejempplo de vector de componetes");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ej25_Vectores.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ej25_Vectores().setVisible(true);
            }
        });
    }
